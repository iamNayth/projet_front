...
<section class="d-none d-lg-block" id="hero-expertises">
    ...
    <div class="container pt-5 pb-5">
        <div class="row mb-4 gy-3">
            ...
            <div class="col-12 col-md-3 d-flex justify-content-center align-items-center flex-column">
                ...
                <div class="line"></div>
                <div class="d-flex align-items-center justify-content-center border border-dark lex w-100 pt-3 pb-3">Branding</div>
            </div>
            <div class="col-12 col-md-3 d-flex justify-content-center align-items-center flex-column">
                <img class="img-fluid" src="../assets/images/creation4.png">
                <div class="line"></div>
                <div class="d-flex align-items-center justify-content-center border border-dark lex w-100 pt-3 pb-3">Montage / Shooting</div>
            </div>
        </div>
        <div class="row gy-3">
            ...
            <div class="col d-flex align-items-center justify-content-center justify-content-md-center">
