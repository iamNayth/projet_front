    ...
    <div class="container">
        <div class="row ">
            <div class="col-12 position-relative">
                ...
                <span class="position-absolute lex fs-6 fw-bold" style="right: 0; bottom: -20px;">Pierre Boule</span>
            </div>
...
<section id="agence-recrutement">
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-12 d-flex flex-column align-items-center justify-content-center">
                <span class='nord fs-3 text-center text-light'>Envie de rejoindre l'equipage ?</span>
                <span class='nord fs-3 text-center text-light'>Contactez-nous !</span>
                <span class='lex fs-1 text-center fw-bolder text-light'>contact@dimension.com</span>
                <span class='lex fs-4 text-center text-light'>ou remplissez le <a href="../public/index.php?page=contact" style="text-decoration:underline; color: white">formulaire de contact</a></span>
            </div>
        </div>
    </div>
</section>
