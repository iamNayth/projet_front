            ...
            <div class="row h-100">
              <div class="col d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-3">
                  <a href="index.php?page=homepage" class="lex text-light fs-5 fw-500">Accueil</a>
                  <a href="index.php?page=projects" class="lex text-light fs-5 fw-500">Projets</a>
                  <a href="index.php?page=admin" class="lex text-light fs-5 fw-500">Admin</a>
                </div>
